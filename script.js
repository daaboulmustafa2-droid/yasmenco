...
const translations = {
  en: {
    ...
    about_body: 'Based in the UAE and working directly with top JCI-accredited hospitals and master surgeons in Istanbul, Yasmen handles every detail of your medical journey. From initial consultation in the UAE to VIP transport, luxury stay, surgical care, and aftercare in Istanbul — you\'re never alone. Her hands-on, empathetic approach has earned her a reputation for trust and excellence across the UAE, GCC, and 30+ countries.',
    ...
    contact_lead: 'Book a free, no-obligation consultation with Yasmen (UAE office or online). We\'ll discuss your goals, answer your questions, and design a personalized health travel plan — all in your language.',
  ...
  ar: {
    ...
    contact_lead: 'احجزي استشارة مجانية مع ياسمين (من الإمارات أو عبر الإنترنت). سنناقش أهدافكِ، ونشرح لكِ تفاصيل العملية في إسطنبول، ونعد خطة سفركِ العلاجية المخصصة — بلغتكِ.',
  ...
  tr: {
    ...
    contact_lead: 'Yasmen ile (BAE ofisimizden veya çevrim içi) ücretsiz bir danışma ayarlayın. Hedeflerinizi konuşalım, İstanbul\'daki ameliyat sürecini açıklayalım ve kişiselleştirilmiş sağlık seyahatinizi planlayalım — kendi dilinizde.',
    contact_wa_title: 'WhatsApp',
